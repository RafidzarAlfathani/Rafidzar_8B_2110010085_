...
if (isset($_POST['buat_pesanan'])) {
    ...
    try {
        ...
        $query_pesanan = "INSERT INTO pesanan (kode_invoice, id_pembeli, alamat_pengiriman, total_bayar, ongkir, status_pesanan, metode_pembayaran)
                          VALUES ('$kode_invoice', '$id_pembeli', '$alamat_pengiriman', '$total_bayar', '$ongkir', '$status_pesanan', '$metode_pembayaran')";
                                ...
                                <div class="order_table table-responsive">
                                    <table>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <th>Pengiriman</th>
                                                <td><strong>Rp 15,000</strong></td> </tr>
                                            <tr class="order_total">
                                                <th>Total Pesanan</th>
                                                <td><strong>Rp <?= number_format($subtotal_checkout + 15000) ?></strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
