                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['tambah'])) {
                            // ... (kode PHP Anda untuk INSERT) ...
                             ...
                             $query = "INSERT INTO produk (id_petani, id_kategori, nama_produk, deskripsi, harga, satuan, stok, status_produk, foto_produk)
                                       VALUES ('$id_petani', '$id_kategori', '$nama_produk', '$deskripsi', '$harga', '$satuan', '$stok', '$status_produk', '$foto_produk')";
