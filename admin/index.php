...
<body class="body-padding body-p-top light-theme">
    ...
    <div class="main-content"> 
        ...
        if ($page == "petani") 
        {
            if ($aksi == "") { include "page/petani/petani.php"; }
            if ($aksi == "tambah") { include "page/petani/tambah.php"; }  
            if ($aksi == "ubah") { include "page/petani/ubah.php"; }  
            if ($aksi == "hapus") { include "page/petani/hapus.php"; }  
        }     
        ...
        if ($page == "produk") 
        {
            if ($aksi == "") { include "page/produk/produk.php"; }
            if ($aksi == "tambah") { include "page/produk/tambah.php"; }  
            if ($aksi == "ubah") { include "page/produk/ubah.php"; }  
            if ($aksi == "hapus") { include "page/produk/hapus.php"; }  
        }   

        if ($page == "kategori_produk") 
        {
            if ($aksi == "") { include "page/kategori_produk/kategori_produk.php"; }
            if ($aksi == "tambah") { include "page/kategori_produk/tambah.php"; }  
            if ($aksi == "ubah") { include "page/kategori_produk/ubah.php"; }  
            if ($aksi == "hapus") { include "page/kategori_produk/hapus.php"; }  
        }    

        if ($page == "pembeli") 
        {
            if ($aksi == "") { include "page/pembeli/pembeli.php"; }
            if ($aksi == "tambah") { include "page/pembeli/tambah.php"; }  
            if ($aksi == "ubah") { include "page/pembeli/ubah.php"; }  
            if ($aksi == "hapus") { include "page/pembeli/hapus.php"; }  
        }       

        if ($page == "kurir") 
        {
            if ($aksi == "") { include "page/kurir/kurir.php"; }
            if ($aksi == "tambah") { include "page/kurir/tambah.php"; }  
            if ($aksi == "ubah") { include "page/kurir/ubah.php"; }  
            if ($aksi == "hapus") { include "page/kurir/hapus.php"; }  
        }   

        if ($page == "riwayat_harga") 
        {
            if ($aksi == "") { include "page/riwayat_harga/riwayat_harga.php"; }
            if ($aksi == "tambah") { include "page/riwayat_harga/tambah.php"; }  
            if ($aksi == "ubah") { include "page/riwayat_harga/ubah.php"; }  
            if ($aksi == "hapus") { include "page/riwayat_harga/hapus.php"; }  
        }    

        if ($page == "pesanan") 
        {
            if ($aksi == "") { include "page/pesanan/pesanan.php"; }
        ...
        if ($page == "tracking") 
        {
            if ($aksi == "") { include "page/tracking/tracking.php"; }
            if ($aksi == "tambah") { include "page/tracking/tambah.php"; }  
            if ($aksi == "ubah") { include "page/tracking/ubah.php"; }  
            if ($aksi == "hapus") { include "page/tracking/hapus.php"; }  
        }     

        if ($page == "laporan") {
            // Laporan Utama
            if ($aksi == "laporan_produk") { include "page/laporan/laporan_produk.php"; }
            if ($aksi == "laporan_petani") { include "page/laporan/laporan_petani.php"; }
            if ($aksi == "laporan_pembeli") { include "page/laporan/laporan_pembeli.php"; }
            if ($aksi == "laporan_pesanan") { include "page/laporan/laporan_pesanan.php"; }

            // Laporan Analisa
            if ($aksi == "laporan_produk_terlaris") { include "page/laporan/laporan_produk_terlaris.php"; }
            if ($aksi == "laporan_pendapatan_petani") { include "page/laporan/laporan_pendapatan_petani.php"; }
            if ($aksi == "laporan_kinerja_kurir") { include "page/laporan/laporan_kinerja_kurir.php"; }

            // Laporan Riwayat
            if ($aksi == "laporan_perubahan_harga") { include "page/laporan/laporan_perubahan_harga.php"; }
            if ($aksi == "laporan_tracking") { include "page/laporan/laporan_tracking.php"; }
        }   
